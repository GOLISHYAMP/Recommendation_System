...
#         print(f"Response Content: {r.text}")  # Print the content for debugging
#         r.raise_for_status()
#         return r.json()  # Try to parse JSON
...
with st.container():
    ...
    with image_column:
        # URL of the image
        image_url = "https://rukminim2.flixcart.com/image/312/312/l4ln8nk0/mobile/6/s/i/-original-imagfgf9nf8psuyv.jpeg?q=70"

        # Fetch and display the image
        st.title("Display Image from URL")
        # image = fetch_image_with_advanced_headers(image_url)
